...
public class Index implements Serializable {
	...
	public Index(String ID, Course course, int totalVacancies) { // constructor for index without tutorial and lab
																	// sessions
		this.ID = ID;
		this.course = course;
	...
	public Index(String ID, Course course, int totalVacancies, List<Session> tutorials) { // constructor for index
